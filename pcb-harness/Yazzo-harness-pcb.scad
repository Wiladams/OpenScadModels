...
// Gumstix Overo Summit expansion board
pcbholder( length = 39.5, width = 80.25, bottomclearance= 4, pcbthickness=1.25, slotdepth=2, grooveclearance=1.3);

// Arduino Duemilanove - Also works with standard Arduino shields
//pcbholder( length = 66, width = 54, bottomclearance= 3, pcbthickness=2, //slotdepth=2, grooveclearance=1.3);

// Arduino MEGA - Also works with standard Arduino shields
//pcbholder( length = 100, width = 54, bottomclearance= 3, pcbthickness=2, slotdepth=2, grooveclearance=1.3);

//LeafLabs Maple - Shorter than an Arduino
//pcbholder( length = 53, width = 54, bottomclearance= 3, pcbthickness=2, slotdepth=2, grooveclearance=1.3);

// Web Platform v1c - http://www.dangerousprototypes.com
//pcbholder( length = 50.5, width = 88.5, bottomclearance= 3, pcbthickness=2, slotdepth=2, grooveclearance=1.3);
...
//pcbholder( length = 25, width =27, bottomclearance= 7, pcbthickness=1, slotdepth=2, grooveclearance=1.3);
